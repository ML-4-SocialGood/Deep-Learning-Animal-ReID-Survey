...
<div style="text-align: center; max-width: 900px; margin: 0 auto;">
  ...
  <p style="font-size: 1.1em; color: #555;">
    <strong>ReWildID</strong> is a standardized evaluation toolkit designed to support reproducible research.
  </p>
  <p>
...
git clone [https://github.com/ML-4-SocialGood/ReWildID.git](https://github.com/ML-4-SocialGood/ReWildID.git)
cd ReWildID
